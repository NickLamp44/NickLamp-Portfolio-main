      ...
      <div className="max-w-[1223px] mx-auto flex justify-between items-center px-6 py-4">
        <ul className="hidden sm:flex gap-8 lg:gap-12 text-white/75">
          <button
            ...
            className={`cursor-pointer ${sectionInView === "home" && "text-white"}`}
          >
            Home
          </button>
          <button
            onClick={() => handleNavClick("work")}
            className={`cursor-pointer ${sectionInView === "work" && "text-white"}`}
          >
            Prior Experience
          </button>
          <button
            onClick={() => handleNavClick("about")}
            className={`cursor-pointer ${sectionInView === "about" && "text-white"}`}
          >
            About
          </button>
        </ul>
